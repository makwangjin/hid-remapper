...
// -------------------------------------------------------------------
// (1) 아래 코드로 기존 our_report_descriptor_kb_mouse[] 를 덮어쓰세요
// -------------------------------------------------------------------
const uint8_t our_report_descriptor_kb_mouse[] = {
    // --- (NEW) KVM-SAFE KEYBOARD (6KRO, Report ID 2) ---
    ...
    // --- (ORIGINAL) COMPLEX MOUSE (WORKING) ---
    0x05, 0x01,              // Usage Page (Generic Desktop Ctrls)
